...
function Companies({ctx}:{ctx:Context}){
  const [rows,setRows]=useState<any[]>([]);const [open,setOpen]=useState(false);const [error,setError]=useState("");const[issued,setIssued]=useState<{company:string;code:string;until:string}|null>(null);
